...
public class LoginServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * post : body에 기록돼서 전달(url에 보이지 않음)
		 * get : head에 기록돼서 전달(url에 보임)
		 */
		
		/* 객체를 담아둘 수 있는 객체들(scope(공유 범위)가 좁은 순위)
		 ...
		 * 4. qpplication : 톰캣이 유지되는 한 모든 곳에서 쓸 수 있다. jsp, servlet, java 모두에서 쓸 수 있다.
		 */
